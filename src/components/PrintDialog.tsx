  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content dir="ltr" className="fixed left-1/2 top-1/2 z-50 w-[560px] max-w-[92vw] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-line bg-surface shadow-harfsaz animate-in fade-in-0 zoom-in-95">
          {/* Header */}
